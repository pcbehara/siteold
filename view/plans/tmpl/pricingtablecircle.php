...
?>
<div id="osm-plans-list-pricing-table-circle" class="osm-container osm-pricingtable-container<?php echo $categoryId; ?>">
	<?php
		...
		if (count($this->items))
		{
			echo OSMembershipHelperHtml::loadCommonLayout('common/tmpl/pricingtable_circle_plans.php', array('items' => $this->items, 'input' => $this->input, 'config' => $this->config, 'Itemid' => $this->Itemid, 'categoryId' => $this->categoryId, 'bootstrapHelper' => $this->bootstrapHelper));
		}
	?>
</div>