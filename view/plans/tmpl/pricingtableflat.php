...
?>
<div id="osm-plans-list-pricing-table-flat" class="osm-container osm-pricingtable-container<?php echo $categoryId; ?>">
	<?php
		...
		if (count($this->items))
		{
			echo OSMembershipHelperHtml::loadCommonLayout('common/tmpl/pricingtable_flat_plans.php', array('items' => $this->items, 'input' => $this->input, 'config' => $this->config, 'Itemid' => $this->Itemid, 'categoryId' => $this->categoryId, 'bootstrapHelper' => $this->bootstrapHelper));
		}
	?>
</div>