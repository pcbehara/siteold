...
class OSMembershipViewUpdateHtml extends MPFViewHtml
{
	public function display()
	{
		...
		if (!$user->id)
		{
			$return = 'index.php?option=com_osmembership&view=update&Itemid=' . $this->Itemid;
		...
		// Fix wrong data for update record
