...
abstract class OSMembershipHelperJquery
{
	...
	public static function validateForm()
	{
		...
		$document->addStyleSheet($rootUri . '/media/com_osmembership/assets/js/validate/css/validationEngine.jquery.css');
		...
		$script = $rootUri . '/media/com_osmembership/assets/js/validate/js/jquery.validationEngine.js';
